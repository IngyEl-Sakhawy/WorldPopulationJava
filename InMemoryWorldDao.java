...
public class InMemoryWorldDao implements WorldDao {
	...
	public static void main(String args[]) {
		...
		CitiesSearch.mostPopulatedCityOfEachCountry(allCountries,allCities);

		
		CitiesSearch.mostPopulatedCityOfEachContinent(allContinents,allCountries,allCities);
		
		
		CitiesSearch.mostPopulatedCapital(allCountries,allCities);
